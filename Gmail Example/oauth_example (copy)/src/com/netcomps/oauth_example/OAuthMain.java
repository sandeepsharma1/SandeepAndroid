...
public class OAuthMain extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		 ...
		 * findViewById(R.id.button_delete_tokens); Button getContacts =
		 * (Button) findViewById(R.id.button_get_contacts);
		 */
		...
		get.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				System.out.println("I am in oauthmain");
				// ArrayList<MailContacts> countryList = MyAdapter.rList;
				ArrayList<String> countryList1 = MyAdapter.selectedEmails;
				for (int i = 0; i < countryList1.size(); i++) {
					String emailId = MyAdapter.selectedEmails.get(i);
					if (emailId == null) {
						return;
					}
					System.out.println("I am in oauthmain2");
					responseText.append("\n" + emailId);
